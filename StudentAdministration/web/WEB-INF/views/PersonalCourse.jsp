...
<table class="table table-bordered" style="width: 1000px" align="center">
    <caption><strong>课程表</strong>&nbsp;&nbsp;<strong><a href="course.html">返回</a></strong></caption>
    <thead>
    <tr>
        <th></th>
        <th>星期一</th>
