        ...
        <div class="col-md-10" style="margin-top: 40px;height:550px;">
                        ...
                        <div class="modal-body">
                            <form role="form">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" placeholder="请输入课程名">
                                </div>
                                <div class="form-group form-inline" style="padding-top:5px;">
                                    <label for="institute">开课学院</label>
                                    <select class="form-control" id="institute">
                                        <option>信息学院</option>
                                        <option>化工学院</option>
                                    </select>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <label for="major">开课专业</label>
                                ...
                                <div class="form-group">
                                    <label for="teacherNo">开课老师号</label>
                                    <input type="text" class="form-control" id="teacherNo" placeholder="请输入老师号">
                                </div>
                                <div class="form-group">
                                    <label for="teachclass">开课地点</label>
                                    <input type="text" class="form-control" id="teachclass" placeholder="请输入地点">
                                </div>
                            </form>
                        </div>
            ...
            <div class="col-md-3 pull-right">
                <div class="input-group">
                    <input type="text" class="form-control" placeholder="请输入课程号">
