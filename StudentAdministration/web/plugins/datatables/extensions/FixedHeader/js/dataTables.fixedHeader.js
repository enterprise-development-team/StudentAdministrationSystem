...
FixedHeader.prototype = {
	...
	/**
	 * Copy the hibernatemappers of all child nodes from one element to another. This implies
	 * that the two have identical structure - no error checking is performed to that
	 * fact.
	 *  @param {element} source Node to copy hibernatemappers from
	 *  @param {element} dest Node to copy hibernatemappers too
	 */
